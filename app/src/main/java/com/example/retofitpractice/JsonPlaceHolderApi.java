...
public interface JsonPlaceHolderApi {
    ...
    Call<List<BankData>> getBankData();
    ...
    Call<List<Comments>> getComment(@Path("id") int postId);

    @GET
    Call<List<Comments>> getComment(@Url String Url);
    ...
    @DELETE("posts/{id}")
    Call<Void> deietePost(@Path("id") int id);
